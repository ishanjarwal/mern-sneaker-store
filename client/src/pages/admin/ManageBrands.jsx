                    ...
                    <tbody>
                        ...
                        {[1, 1, 1].map((el, index) => (
                            <tr>
                                ...
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>NIKE</td>
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                <div className='py-6 px-6'>
                                    <h2 className='text-2xl font-bold uppercase'>Create a New Brand</h2>
                                    <form className='mt-8'>
                                        <label>
                                            Brand Name
                                        </label>
                                        <input className='py-2 px-4 rounded-md border-gray-300 border w-full' type="text" />
                                        <button className='py-2 px-4 rounded-md bg-black text-white uppercase mt-2 w-full'>
                                            Create
                                        </button>
                                    </form>
                                </div>
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                    Deleting this Brand will also delete all the products belonging to this brand. The Action can't be undone.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
