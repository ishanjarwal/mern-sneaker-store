            ...
            <div className='overflow-auto'>
                <table className='table-auto w-full border' style={{ minWidth: '768px' }}>
                    ...
                    <tbody>
                        ...
                        {[1, 1, 1].map((el, index) => (
                            <tr>
                                <td className='text-start py-2 px-2 border border-muted-text'>1</td>
                                <td className='text-start py-2 px-2 border border-muted-text'>
                                    <img
                                        className='w-32 h-24 object-cover object-center mx-auto'
                                        src={'https://www.superkicks.in/cdn/shop/files/2_b1418517-bed6-4da9-8d44-bc760f7dd04d.jpg?v=1698738108&width=1946'} alt={sampleProduct.title} />
                                </td>
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>{sampleProduct.title}</td>
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>{'23rd July 2024, 12:00:00'}</td>
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>{'23rd July 2024, 12:00:00'}</td>
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>{sampleProduct.category}</td>
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>{sampleProduct.brand}</td>
                                <td className='text-start text-sm py-2 px-2 border border-muted-text'>{sampleProduct.stock}</td>
...
const EditModal = ({ showEditModal, setShowEditModal, product }) => {
    return (
