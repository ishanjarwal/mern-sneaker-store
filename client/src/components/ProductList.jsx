...
import { fetchAllProductsAsync } from '../slices/productSlice'
...
const ProductList = () => {
    ...
    useEffect(() => {
        dispatch(fetchAllProductsAsync({ pagination: paginationOptions, sort: sortOptions, filters: filterOptions }));
